...
import Main.Exceptions.PersonIllegalArgumentException;
...
//    }
    ...
    public void setPersonId(int personId) {
        ...
        if (personId >= 101 && personId <= 999)
            ...
            throw new PersonIllegalArgumentException(Integer.toString(personId)
    ...
    public void setFirstName(String firstName) {
        ...
        if (firstName != null && firstName.length() > 2 && firstName.length() <= 15)
            ...
            throw new PersonIllegalArgumentException (
                    "Person with ID "+ personId +", first name: "+ firstName    + " is invalid. First name must be > 2 and <= 15 characters");
    }
    ...
    public void setLastName(String lastName) {
        ...
        if (lastName != null && lastName.length() >= 2 && lastName.length() <= 30) {
            ...
            throw new PersonIllegalArgumentException (
                    "Person with ID "+ personId +", last name: " + " is invalid. Last name must be between 2 and 30 characters");
    ...
    public void setUserName(String userName){
        ...
        if (userName!= null && userName.length() >= 5 && userName.length() <= 30) {
            switch (userName.toLowerCase()) {
                ...
                case "supervisor":
                    throw new PersonIllegalArgumentException (
                            "Person with ID "+ personId +", username : "+  userName + " is invalid. Admin user names not allowed");
            ...
            throw new PersonIllegalArgumentException (
                    "Person with ID "+ personId +", username : "+ userName + " is invalid. User name must be between 5 and 30 characters");
